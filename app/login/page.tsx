        ...
        <div className="bg-gray-900/50 backdrop-blur-xl rounded-3xl p-8 border border-gray-700 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gradient-to-r from-orange-600 to-red-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold rounded-xl shadow-lg disabled:opacity-50"
            >
